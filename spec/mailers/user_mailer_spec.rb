...
RSpec.describe UserMailer do
  ...
  context "added an authorized user" do
    ...
    it "should display message conclusion" do
      expect(@mail).to have_xpath("//p[normalize-space(text()) = 'Please contact the BMIC at #{CONTACT_US_EMAIL['to']} for assistance with this process or with any questions you may have.']")
    end
